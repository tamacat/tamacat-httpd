...
public class PropertyUtilsTest {
    ...
    static final String path1 = "org/tamacat/httpd/core/di/DIContainer.properties";
    static final String path2 = "org.tamacat.httpd.core.di.DIContainer.properties";
    static final String path3 = "test.xml";

    static final String path4 = "org/tamacat/httpd/core/di/not_found.properties";

//    @Test
//    public void testGetProperties() {
//        Properties props1 = PropertyUtils.getProperties(path1);
//        assertEquals("org.tamacat.httpd.core.di.impl.UnloadableClassLoader",
