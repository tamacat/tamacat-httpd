...
package org.tamacat.httpcore4.testserver;
...
import org.tamacat.httpcore4.impl.bootstrap.ServerBootstrap;
...
public class HttpServer {
    ...
    private volatile org.tamacat.httpcore4.impl.bootstrap.HttpServer server;
    ...
    public int getPort() {
        final org.tamacat.httpcore4.impl.bootstrap.HttpServer local = this.server;
        if (local != null) {
